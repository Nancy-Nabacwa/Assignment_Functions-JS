/* No.1 Given an array of strings, use a function to reverse all the elements
 in the string in ascending order and the specific elements in descending order*/
let  arrX = ['Yeast', 'bake','apple','price','boaked','Apendix','apendix'];
arrX.sort((x,y)=> x.toLowerCase() <y.toLowerCase() ? -1:1)
console.log('sorted Array Ascending',arrX)
arrX.sort((x,y)=>x.toLowerCase() <y.toLowerCase() ? 1:-1)
console.log('sorted Array Descending',arrX)

/* NO.2 Using JS functions and an array of numbers, return positive if an element within the array 
...
/* NO.3 Given an array of objects, where each object represents an employee with an id, name, and salary property,
...
let sortedArrayOfOjects = arrayOfObjects.sort(
 ...
 /* N0.4 Write a function that accepts an array of numbers and uses the forEach() method 
...
/* NO.5 Write a function that takes in an array of numbers and consoles the first four items 
